...
namespace ImperativeToFunctional
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            highestPopulation = cities.Max(i => i.Population);
            ...
            earliestFounding = cities.Min(i => i.Founded);
            ...
            double averagePopulationDensity = Math.Round(cities.Select(i => i.Population / i.Area).ToArray().Sum()  / cities.Length);
            ...
            longNameCities = cities.Where(i => i.Name.Length > 6).ToList();
